...
var	connectionOnConnect = function(err,cb){
	if(err){
		...
		connection().query("SELECT CAST(bill_createddate as DATE) AS bill_createddate,bill_totalpayment FROM nodetest.testbilling ORDER BY bill_createddate ASC LIMIT 50;"
